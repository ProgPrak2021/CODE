    ...
    for elem in data:
        if domain in elem['hostnames']:
            ...
            data_summary['privacyspy']['rubric']['Handling'][
                'Does the policy allow personally - targeted or behavioral marketing?']['percent'] = \
            elem['rubric'][0]['option']['percent']
            data_summary['privacyspy']['rubric']['Handling'][
                'Does the policy allow personally - targeted or behavioral marketing?']['value'] = elem['rubric'][0][
                'value']

            data_summary['privacyspy']['rubric']['Handling'][
                'Does the service allow you to permanently delete your personal data?']['percent'] = \
            elem['rubric'][4]['option']['percent']
            data_summary['privacyspy']['rubric']['Handling'][
                'Does the service allow you to permanently delete your personal data?']['value'] = elem['rubric'][4][
                'value']

            data_summary['privacyspy']['rubric']['Handling'][
                'Does the service allow third-party access to private personal data?']['percent'] = \
            elem['rubric'][6]['option']['percent']
            data_summary['privacyspy']['rubric']['Handling'][
                'Does the service allow third-party access to private personal data?']['value'] = elem['rubric'][6][
                'value']

            data_summary['privacyspy']['rubric']['Handling'][
                'When does the policy allow law enforcement access to personal data?']['percent'] = \
            elem['rubric'][9]['option']['percent']
            data_summary['privacyspy']['rubric']['Handling'][
                'When does the policy allow law enforcement access to personal data?']['value'] = elem['rubric'][9][
                'value']

            # transparency

            data_summary['privacyspy']['rubric']['Transparency'][
                'Does the policy outline the service general security practices?']['percent'] = \
            elem['rubric'][1]['option']['percent']
            data_summary['privacyspy']['rubric']['Transparency'][
            ...
            data_summary['privacyspy']['rubric']['Transparency'][
                'Does the policy require users to be notified in case of a data breach?']['percent'] = \
            elem['rubric'][5]['option']['percent']
            data_summary['privacyspy']['rubric']['Transparency'][
                'Does the policy require users to be notified in case of a data breach?']['value'] = elem['rubric'][5][
                'value']

            data_summary['privacyspy']['rubric']['Transparency'][
                'Will affected users be notified when the policy is meaningfully changed?']['percent'] = \
            elem['rubric'][11]['option']['percent']
            data_summary['privacyspy']['rubric']['Transparency'][
                'Will affected users be notified when the policy is meaningfully changed?']['value'] = \
            elem['rubric'][11]['value']

            # controlling

            data_summary['privacyspy']['rubric']['Collection'][
                'Does the service collect personal data from third parties?']['percent'] = elem['rubric'][2]['option'][
                'percent']
            data_summary['privacyspy']['rubric']['Collection'][
                'Does the service collect personal data from third parties?']['value'] = elem['rubric'][2]['value']

            data_summary['privacyspy']['rubric']['Collection'][
                'Is it clear why the service collects the personal data that it does?']['percent'] = \
            elem['rubric'][7]['option']['percent']
            data_summary['privacyspy']['rubric']['Collection'][
                'Is it clear why the service collects the personal data that it does?']['value'] = elem['rubric'][7][
                'value']

            data_summary['privacyspy']['rubric']['Collection'][
                'Does the service allow the user to control whether personal data is collected or used for non-critical purposes?'][
                'percent'] = elem['rubric'][8]['option']['percent']
            data_summary['privacyspy']['rubric']['Collection'][
                'Does the service allow the user to control whether personal data is collected or used for non-critical purposes?'][
                'value'] = elem['rubric'][8]['value']

            data_summary['privacyspy']['rubric']['Collection'][
                'Does the policy list the personal data it collects?']['percent'] = elem['rubric'][10]['option'][
                'percent']
            data_summary['privacyspy']['rubric']['Collection'][
